...
# Missing CRITICAL_TOOLS can lead to some necessary operations failed.
...
CRITICAL_TOOLS ?= swagger mockgen gotests git-chglog coscmd go-mod-outdated protoc-gen-go go-gitlint # cfssl
TRIVIAL_TOOLS ?= go-callvis richgo # coscli
